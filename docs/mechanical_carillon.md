...
- 🔔 [Simulation Results](../artifacts/mechanical_carillon/sim/) - Acoustic and mechanical analysis
- 🔧 [Source Code](../src/davinci_codex/inventions/mechanical_carillon.py) - Python implementation
- 📐 [CAD Models](../cad/mechanical_carillon/) - Parametric tower design
- 🎵 [Musical Programs](../artifacts/mechanical_carillon/programs/) - Historical bell sequences
