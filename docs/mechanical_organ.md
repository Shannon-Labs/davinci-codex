...
- 🎼 [Simulation Results](../artifacts/mechanical_organ/sim/) - Acoustic and mechanical analysis
- 🔧 [Source Code](../src/davinci_codex/inventions/mechanical_organ.py) - Python implementation
- 📐 [CAD Models](../cad/mechanical_organ/) - Parametric organ design
- 🎵 [Musical Programs](../artifacts/mechanical_organ/programs/) - Historical compositions
